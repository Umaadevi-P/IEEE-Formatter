"""
Layer D: User Edits Application
Applies user-provided corrections (author, affiliation, keywords, section type fixes)
to a parsed document before re-running the formatting pipeline.
"""
